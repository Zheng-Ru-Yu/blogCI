...
<div id="OSC_Banner">
    <div id="OSC_Slogon">Jony's Blog</div>
    <div id="OSC_Channels">
        <ul>
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
				<?php echo $this->session->userdata('name');?> [ <a href="user/Y">退出</a> ]
...
<ul>
  ...
  <li class="Blog" id="blog_24027">
	<h2 class="BlogAccess_true BlogTop_0"><a href="blog/view/<?php echo $v->BLOG_ID?>"><?php echo $v->TITLE?></a></h2>
	<div class="outline">
	  <span class="time"><?php echo $v->ADD_TIME?></span>
	  <span class="catalog">分类: <a href="#">工作日志</a></span>
	  <span class="stat">统计: 1评/4阅</span>
	  	  <span class="blog_admin">( <a href="blog/update/<?php echo $v->BLOG_ID?>">修改</a> | <a href="blog/delet/<?php echo $v->BLOG_ID?>">删除</a> )</span>	  
	  	</div>
		<div class="TextContent" id="blog_content_24027">
			<?php echo $v->CONTENT?>
		<div class="fullcontent"><a href="blog/view/<?php echo $v->BLOG_ID?>">阅读全文...</a></div>
			</div>
	  </li>
	  <?php }?>
