...
<div id="OSC_Banner">
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
				<?php echo $this->session->userdata('name');?> [ <a href="#">退出</a>] <span id="OSC_Notification">
...
<div class="Blog">
  ...
  <div class="BlogTitle">
    ...
    <div class="BlogStat">
						<span class="admin">
			<a href="blog/update/<?php echo $blog->BLOG_ID?>">编辑</a>&nbsp;|&nbsp;<a href="javascript:delete_blog(24026)">删除</a>
		</span>
				发表于1小时前 , 
