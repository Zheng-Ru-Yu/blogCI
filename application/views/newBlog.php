...
<ul>
    ...
    <div id="AdminContent">
<div class="MainForm">
<form id="BlogForm" action="blog/do_update" method="POST">
<input id="hdn_blog_id" name="hid" value="<?php echo $blog->BLOG_ID?>" type="hidden">
  <table>
  <tbody><tr><td class="t">标题（必填）</td></tr>
  <tr>
	<td>
    <input name="title" id="f_title" class="TEXT" value="<?php echo $blog->TITLE?>" style="width: 400px;" type="text">
	存放于 
	<select name="catalog">
	)
